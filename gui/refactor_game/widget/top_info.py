...
class TopInfo(tk.Frame):
    ...
    def set_labels(self,
        ...
        self.player_time_left_stringvar[Player.ONE].set(f'Player1 Time Left: {player_1_time_left / 100:0.2f}')
        ...
        self.player_time_left_stringvar[Player.TWO].set(f'Player2 Time_left: {player_2_time_left / 100:0.2f}')
